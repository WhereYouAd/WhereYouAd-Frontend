...
export function useAccount() {
  ...
  function useChangePassword(
    options?: TChangePasswordMutationOptions,
  ): TChangePasswordMutationResult {
    return useCoreMutation<void, TChangePasswordPayload>(
      changePassword,
      options,
    );
  }
  ...
  function useChangeNickname(
    options?: TChangeNicknameMutationOptions,
  ): TChangeNicknameMutationResult {
    return useCoreMutation<TChangeNicknameResponse, TChangeNicknamePayload>(
      changeNickname,
      options,
    );
  }
  ...
  function useResetPreferences(
    options?: TUseMutationCustomOptions<TResetPreferencesResponse, void>,
  ) {
    return useCoreMutation<TResetPreferencesResponse, void>(
      resetPreferences,
      options,
    );
  }
