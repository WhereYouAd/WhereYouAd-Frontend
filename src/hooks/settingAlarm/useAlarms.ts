...
import type {
  TAlarmSettings,
  TGetAlarmSettingsResp,
  TPatchAlarmSettingsResp,
} from "@/types/settingAlarm/alarm";
...
export function useGetAlarmSettings() {
  return useCoreQuery<TGetAlarmSettingsResp, TAlarmSettings>(
    ["alarmSettings"],
    getAlarmSettings,
    {
...
export function usePatchAlarmSettings() {
  ...
  return useCoreMutation<TPatchAlarmSettingsResp, TAlarmSettings>(
    patchAlarmSettings,
    {
      onSuccess: () => {
