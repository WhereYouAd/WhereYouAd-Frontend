    ...
    ads: [
      {
        ...
        platform: ["google"],
        description:
          "봄을 맞이하여 20%를 할인하는 배너입니다. 봄을 맞이하여 20%를 할인하는 배너입니다. 봄을 맞이하여 20%를 할인하는 배너입니다.",
      ...
      },
      {
        ...
        platform: ["naver"],
        description:
          "해당 광고는 10-20대 전체 대상으로 호남지방에 집중적으로 진행하였습니다. 그리고 광고는 어쩌고저쩌고 프로모션으로써 학생/대학생이 주로 클릭할것으로 예상됩니다.",
