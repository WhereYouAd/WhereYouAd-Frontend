    ...
    <div className="flex flex-col bg-white relative">
      <div className="flex flex-col px-2 sm:px-4 gap-8 pb-8 pt-2">
        ...
        <div className="rounded-[24px] bg-logo-1/6 p-7 text-left mx-1">
          <h3 className="flex items-center gap-2 text-logo-1 font-body1 font-bold mb-3">
        ...
        <div className="flex flex-col px-2 gap-6">
          {data.sections.map((section) => (
            ...
            >
              <h3 className="text-text-main font-body1 font-extrabold tracking-[-0.01em]">
                {section.title}
              </h3>
        ...
        <div className="rounded-[24px] bg-status-red/6 p-7 text-left mx-1">
          <h3 className="flex items-center gap-2 text-status-red font-body1 font-bold mb-3 tracking-tight">
