...
export default function OverviewAiReportPanel() {
  ...
  return (
    <div className="flex flex-col h-full bg-white relative overflow-hidden">
      <div className="flex flex-col px-2 sm:px-4 h-full justify-between pb-8 pt-2">
        {/* 타이틀 */}
        <div className="flex flex-col gap-2.5 text-left mb-6 px-2 shrink-0">
        ...
        {/* 전략 제안 */}
        <div className="rounded-[24px] bg-logo-1/6 p-7 text-left shrink-0 mx-1">
        ...
        {/* 성과 요약 */}
        <div className="flex flex-col justify-around flex-1 py-8 px-2 gap-8">
        ...
        {/* 주의 */}
        <div className="rounded-[24px] bg-status-red/6 p-7 text-left shrink-0 mx-1 mt-2">
