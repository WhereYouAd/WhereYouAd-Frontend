        ...
        {!sendCode ? (
          ...
          <div className="relative w-full">
            <CommonAuthInput
              ...
              value={watchedEmail || ""}
              readOnly
              className="w-full h-13.5 px-5 border rounded-2xl font-body1 text-text-title bg-surface-100 border-surface-400 focus:outline-none focus:border-surface-400"
            />
            <button
              type="button"
