  ...
  return (
    <div className="flex flex-col h-full font-pretendard">
      <div className="flex flex-col gap-2 mb-8">
        <h4 className="font-body1 text-text-main tracking-tight">성과 순위</h4>
        <div className="bg-bg-surface/30 px-3 py-1.5 rounded-full border border-bg-surface w-fit">
          <span className="font-caption font-semibold text-text-sub text-[13px] tracking-tight">
            ROAS(%) = 매출 ÷ 광고비 × 100
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col flex-1">
        <div className="grid grid-cols-[28px_1fr_4.5rem_auto] gap-x-4 sm:gap-x-6 px-4 mb-3 font-body2 text-text-auth-sub uppercase tracking-widest pb-3 border-b border-bg-surface">
          <span className="text-center">#</span>
          <span className="whitespace-nowrap">플랫폼</span>
          ...
          {platformRoasRanking.map((platform, index) => (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-text-main font-body2 font-semibold! tracking-tight">
                  {platform.name}
                </span>
              </div>

              <span className="text-right text-text-main font-body2 font-semibold! tracking-tight">
                {platform.roas}%
              </span>

              <div className="flex flex-col items-end justify-center min-w-22">
                <span className="font-body1 font-bold! text-text-main tracking-tight leading-none mb-0.75">
                  ₩{platform.revenue.toLocaleString()}
                </span>
                <span className="font-caption text-text-sub opacity-70 tracking-tight leading-none">
