...
const ComingSoonPlaceholder = memo(function ComingSoonPlaceholder({
  ...
  return (
    ...
    >
      <motion.div
        className="flex w-full max-w-[420px] flex-col items-center rounded-[32px] bg-white px-8 py-12 text-center shadow-card transition-smooth hover:shadow-card-hover tablet:px-6"
        role="status"
        aria-live="polite"
        initial="hidden"
        animate="visible"
