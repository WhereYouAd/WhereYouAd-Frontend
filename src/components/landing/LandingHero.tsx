  ...
  return (
    <section className="relative w-full overflow-hidden bg-brand-300">
      ...
      >
        ...
        <h1 className="text-text-main tracking-[-0.03em] leading-[1.15] break-keep font-bold whitespace-pre-line text-[26px] sm:text-[36px] md:text-[64px]">
          광고 성과를 실시간으로{"\n"}한 화면에서 관리하세요
        </h1>
        <p className="text-[15px] text-text-auth-sub font-normal break-keep max-w-2xl">
      ...
      <motion.div
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-brand-900/55"
